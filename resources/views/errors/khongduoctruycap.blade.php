        ...
        <body>
            ...
            <div class="description_content">
                <div class="text-content container">
                    <div class="col-md-12">
                        <h1 style="font-family: Time new romance; width: 100%">403 - Bạn Không Được Quyền Vào Trang Này. Hãy Đăng Nhập Bằng Tài Khoản ADMIN Để Sử Dụng Trang Này!!!!</h1>
                        <div class="fa  fa-user-times fa-2x"></div>
                        
						<a href="{{ route('index')}}" class="fa-2x">Nhấn Vào Đây Để Quay Lại Trang Chủ</a>
                    ...
                    <div class="col-md-12">
                        <div class="img-section">
                           <img src="{{ asset ('theme/homepage/image/401.jpg') }}" width="350" height="220">
                           <img src="{{ asset ('theme/homepage/image/error.jpg') }}" width="350" height="220">
