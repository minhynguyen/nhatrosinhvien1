...
class nhatro extends Model
{
    ...
    protected $fillable = ['nt_ten','nt_sdtlienhe', 'nt_diachi', 'nt_kinhdo', 'nt_vido', 'nt_giathue', 'nt_giadien', 'nt_gianuoc', 'nt_dientich', 'nt_taomoi', 'nt_capnhat', 'nt_trangthai', 'id', 'lnt_ma'];
